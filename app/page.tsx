  ...
  return (
    <div className="min-h-[100dvh] relative overflow-hidden flex flex-col">
      ...
      <header className="relative z-50 flex-shrink-0">
        <div className="flex items-center justify-center h-14 sm:h-16 md:h-20 px-4 sm:px-6">
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.3 }}
            className="text-white text-[11px] sm:text-[14px] md:text-xl lg:text-2xl tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.35em] font-display uppercase font-light"
          >
            HOUSE OF CLARENCE
          </motion.h1>
        </div>
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-5 sm:px-6 py-8">
        <motion.div
        ...
        >
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-display tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.3em] mb-4 sm:mb-6 font-light"
          >
            COMING SOON
          </motion.h2>
          ...
          <motion.p
            ...
            transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1] }}
            className="text-[11px] sm:text-[13px] md:text-[15px] tracking-[0.15em] sm:tracking-[0.2em] mb-8 sm:mb-12 font-light uppercase"
          >
          ...
          <motion.p
            ...
            transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1] }}
            className="text-white/80 text-[13px] sm:text-sm md:text-base leading-relaxed max-w-xl mx-auto mb-8 sm:mb-12 font-light px-2"
          >
            ...
            <AnimatePresence mode="wait">
              {!isSubmitted ? (
                ...
                >
                  ...
                  <motion.p 
                    className="text-white/50 text-[10px] sm:text-[11px] tracking-wider mt-4"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                >
                  <motion.div
                    ...
                    className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-5 sm:mb-6 border border-white/50 rounded-full 
                  ...
                  <h3 className="text-white text-base sm:text-lg tracking-[0.15em] uppercase mb-2 font-display">
                    Thank You
                  </h3>
      ...
      {/* Footer */}
      <footer className="relative z-20 flex-shrink-0 p-4 sm:p-6 md:p-8">
        <div className="flex flex-col items-center gap-4 sm:gap-5 max-w-6xl mx-auto">
          {/* Social links - more prominent on mobile */}
          <motion.div 
          ...
          <motion.div 
            className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6 text-white/50 text-[10px] sm:text-[11px] tracking-[0.1em] sm:tracking-[0.12em] uppercase"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <a
              ...
              className="hover:text-white active:text-white transition-colors duration-300"
            >
